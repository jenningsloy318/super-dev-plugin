...
<purpose>Activate dev-executor and qa-agent in PARALLEL for Stage 8 implementation. Dev-executor implements code according to specifications. QA-agent writes and runs tests. Build queue managed for Rust/Go projects.</purpose>
...
<output>
  <format>Implemented code files and test suites. Documentation updates handled separately in Stage 10.</format>
</output>
