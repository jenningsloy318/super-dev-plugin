...
<purpose>Activate the code-reviewer agent to review code against specification. Assess correctness, security, performance, and maintainability. Runs in parallel with adversarial review in Stage 9.</purpose>
...
<constraints>
  ...
  <constraint>Runs in parallel with adversarial review in Stage 9</constraint>
