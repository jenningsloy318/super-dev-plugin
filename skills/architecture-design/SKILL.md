...
<purpose>Activate the architecture-designer agent (or product-designer for features needing both architecture and UI) for Stage 6 architecture design. Produces module decomposition, interfaces, ADRs, data flow diagrams, and evaluation matrices. Use for new features or new modules — for improving existing architecture, use /super-dev:improve-architecture instead.</purpose>
