...
<process>
  ...
  <step n="4" name="Signal Completion">After all tasks: report completion to Team Lead with files_changed list. If blocked: `DEV_BLOCKED: [task_id] [error_description]`.</step>
</process>
