...
<constraints>
  ...
  <constraint name="JSON Tracking File (MANDATORY)">Create and maintain `[spec-index]-[spec-name]-workflow-tracking.json` in the spec directory. Track stages, implementation phases, iterations, timestamps, and completion status.</constraint>
