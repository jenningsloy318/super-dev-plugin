...
Example: for an empty directory, Stage 3 = `01-requirements.md`, Stage 3.5 = `02-bdd-scenarios.md` (NOT `02-bdd-scenarios.md`). NEVER derive suffix from stage display name — always use this lookup table.</constraint>
