...
6. BDD-aligned: derive test plan from Gherkin scenarios in `[doc-index]-behavior-scenarios.md`, mapping each scenario to at least one test case with SCENARIO-ID references
...
- [ ] All BDD scenarios from `[doc-index]-behavior-scenarios.md` have corresponding test implementations with SCENARIO-ID references
