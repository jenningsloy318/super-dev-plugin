...
<process>
  ...
  <step n="5" name="Write Report">Load `${PLUGIN_ROOT}/reference/qa-report-template.md` and fill in all placeholders. Write report to `{spec_directory}/{output_filename}`. Include: test status, coverage metrics, BDD scenario mapping, defect list.</step>
