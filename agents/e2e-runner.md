...
<collaboration>
  Runs as Step 9.5 in the sequential TDD workflow (Web/UI features only):
  tdd-guide (9.1) → domain specialist (9.2) → impl-summary-writer (9.3) → qa-agent (9.4) → e2e-runner (9.5).
