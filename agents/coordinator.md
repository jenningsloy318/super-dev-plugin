...
**CRITICAL ENFORCEMENT:** You and ALL sub-agents MUST NOT call MCP tools directly. Always use wrapper scripts via Bash.
...
**ENFORCEMENT:** Reject any sub-agent output that uses direct MCP calls and require re-execution with scripts.
