...
<collaboration>
  Runs as Step 9.2 in the sequential TDD workflow: tdd-guide (9.1) → golang-developer (9.2) → impl-summary-writer (9.3) → qa-agent (9.4). Receives test files from Step 9.1 and makes them pass.
</collaboration>
