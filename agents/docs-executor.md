...
<output name="Documents to Update">
  ...
  - Implementation Summary (`*-implementation-summary.md`): Compile complete development story (CREATE if not exists). Schema: `{plugin_root}/templates/schemas/implementation-summary.schema.json`, render via `{plugin_root}/scripts/render.sh`
