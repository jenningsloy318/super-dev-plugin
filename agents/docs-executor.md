...
<constraints>
  <constraint>**NEVER delay updates** — Update all docs immediately after code review approval</constraint>
  <constraint>**NEVER skip updates** — Complete all document updates in single pass</constraint>
  <constraint>**ALWAYS commit with code** — Docs and code committed together</constraint>
  <constraint>**ALWAYS track deviations** — Document any spec changes discovered during review</constraint>
</constraints>
