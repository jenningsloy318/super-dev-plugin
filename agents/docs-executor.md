...
<output name="Documents to Update">
  ...
  - Implementation Summary (`*-implementation-summary.md`): Compile complete development story (CREATE if not exists). Follow the structure in `{plugin_root}/templates/implementation-summary.md.j2`.
