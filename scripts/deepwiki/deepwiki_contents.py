#!/usr/bin/env python3
"""
DeepWiki Contents Script: Get documentation contents for a GitHub repository.

Connects to the DeepWiki MCP HTTP server configured in Claude Code.
Returns the full documentation content for the specified repository.

Usage:
    python3 deepwiki_contents.py --repo "owner/repo"
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Get documentation contents for a GitHub repository using DeepWiki"
    )
