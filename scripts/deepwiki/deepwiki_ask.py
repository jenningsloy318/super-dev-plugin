#!/usr/bin/env python3
"""
DeepWiki Ask Script: Ask questions about a GitHub repository.

Connects to the DeepWiki MCP HTTP server configured in Claude Code.
Uses AI to answer questions about the repository based on its documentation.

Usage:
    python3 deepwiki_ask.py --repo "owner/repo" --question "How do I install?"
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Ask questions about a GitHub repository using DeepWiki"
    )
