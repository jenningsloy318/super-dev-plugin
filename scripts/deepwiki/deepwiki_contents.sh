#!/usr/bin/env bash
#
# DeepWiki Contents Script (mcp-cli version)
#
# Get documentation contents for a GitHub repository using DeepWiki MCP server via mcp-cli.
#
# Usage:
#   ./deepwiki_contents.sh --repo "owner/repo"
#
# Examples:
#   ./deepwiki_contents.sh --repo "facebook/react"
#   ./deepwiki_contents.sh -r "vercel/next.js"
#
# Output:
#   JSON formatted documentation content to stdout
#
...
Get documentation contents for a GitHub repository using DeepWiki MCP server.
...
Examples:
  # Get React documentation contents
  $SCRIPT_NAME --repo "facebook/react"

  # Get Next.js documentation contents
