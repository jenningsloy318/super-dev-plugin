...
<directives>
  <directive severity="high" name="Haiku 4.5">90% of Sonnet, 3x savings: Use for lightweight agents, pair programming, worker agents in multi-agent systems</directive>
  <directive severity="high" name="Sonnet 4.5">Best coding model: Use for main development work, orchestrating workflows, complex coding tasks</directive>
  <directive severity="high" name="Opus 4.5">Deepest reasoning: Use for complex architecture decisions, maximum reasoning, research and analysis</directive>
