...
<principles>
  <principle>**First Principles Analysis**: Break down bugs to fundamental truths — what actually happens vs. what should happen — then build understanding from there</principle>
  ...
  <principle>**Minimal Reproduction**: Reduce complex issues to minimal reproducible cases for faster root cause identification</principle>
</principles>
