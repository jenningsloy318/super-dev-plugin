...
<purpose>Reference for systematic root cause analysis and bug investigation during Stage 4 (Debug Analysis) of the super-dev workflow.</purpose>
...
<references>
  <ref>Extracted from `super-dev:debug-analyzer` agent. For full agent behavior during Stage 4, invoke with subagent_type "super-dev:debug-analyzer".</ref>
</references>
