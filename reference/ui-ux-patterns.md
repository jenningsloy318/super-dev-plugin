...
<purpose>Reference for user interface and experience design during Stage 6 (UI/UX Design) of the super-dev workflow. Covers layout patterns, navigation, components, interaction patterns, state handling, design tokens, accessibility, and responsive design.</purpose>
...
<references>
  <ref>Extracted from `super-dev:ui-ux-designer` agent. For full agent behavior during Stage 6, invoke with subagent_type "super-dev:ui-ux-designer".</ref>
</references>
