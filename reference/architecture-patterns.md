...
<purpose>Reference for software architecture design during Stage 6 (Architecture Design) of the super-dev workflow. Covers SOLID principles, module decomposition, data access, communication, state management, caching, and deployment patterns.</purpose>
...
<references>
  <ref>Extracted from `super-dev:architecture-designer`. For full agent behavior during Stage 6, invoke with subagent_type "super-dev:architecture-designer".</ref>
</references>
